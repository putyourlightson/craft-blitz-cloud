...
This plugin requires [Craft CMS](https://craftcms.com/) 5.0.0 or later, [Blitz](https://putyourlightson.com/plugins/blitz) 5.0.0 or later, and [Craft Cloud Extension](https://github.com/craftcms/cloud-extension-yii2/) 2.1.0 or 3.1.0 or later.
